...
class TeslaBattery : public CanBattery {
 ...
 protected:
  ...
  static const int RAMPDOWN_SOC = 900;  // Default: start ramping max charge power at 90% SOC
  ...
  virtual int get_rampdown_soc() const { return RAMPDOWN_SOC; }
...
class TeslaModel3YBattery : public TeslaBattery {
 ...
 protected:
  int get_rampdown_soc() const override { return 950; }  // Start ramping closer to top of pack
};
